...
public:
    ...
    bool detect(cv::InputArray img, cv::OutputArray points)
    {
        ...
        //调用 qrdet.init(inarr, p->epsX, p->epsY),设置 qrdet.coeff_expansion, qrdet.barcode, 
        //qrdet.bin_barcode(二值化图像), qrdet.eps_vertical, qrdet.eps_horizontal
        //调用 qrdet.localization(),
    }
